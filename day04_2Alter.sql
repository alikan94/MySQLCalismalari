...
alter table personel add column ulke_ismi varchar(40) default 'Turkiye';
...
alter table isciler MODIFY ulke_adi varchar(30) NOT NULL default 'TURKEY';

-- maas 3000'e esit veya kucuk olan degerler veri olarak girilemesin
alter table isciler add constraint check (maas >= 3000);	
INSERT INTO isciler VALUES(789132465, 'Ali Kan', 'Isparta', 4500, 'Rohan','E',28);
INSERT INTO isciler VALUES(789132466, 'Seymos', 'Isparta', 3001, 'Rohan','E',28);
